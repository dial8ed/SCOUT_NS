...
{
    public class TotePutAwayTransactionSpecification : TransactionSpecification
    {
        ...
        public TotePutAwayTransactionSpecification(Shopfloorline shopfloorline, TransactionType type)
            : base(type)
        {
