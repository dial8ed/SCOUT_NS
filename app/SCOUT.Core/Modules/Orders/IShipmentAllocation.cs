...
namespace SCOUT.Core.Data
{
    public interface IShipmentAllocation
    {
        ...
        ICollection<OrderAllocationDetails> GetOrdersByPartNumber(IUnitOfWork uow, Shopfloorline shopfloorline, Part part);
        string Id { get; }
    ...
    public abstract class ShipmentAllocationMethodBase : IShipmentAllocation
    {
        ...
        public ICollection<OrderAllocationDetails> GetOrdersByPartNumber(IUnitOfWork uow, Shopfloorline shopfloorline, Part part)
        {
            ...
            return Scout.Core.Data
                    .GetList<OrderAllocationDetails>(uow)
                    .ByCriteria(criteria);
        }
