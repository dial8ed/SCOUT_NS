...
namespace SCOUT.WinForms.Views.Warehouse.Shipping
{
    public class ShippingSession
    {
        ...
        public OrderAllocationDetails CurrentOrder { get; private set;}
        ...
        public event ChangedEventHandler<OrderAllocationDetails> OrderChanged;
        ...
        public void ShipInventoryItem(InventoryItem item)
        {
            ...
            if(Scout.Core.Modules.Warehouse.Shipping.Ship(facts))
            {
                if (ItemShipped != null)
                    ItemShipped(this);
            }            
        ...
        private ShipmentFacts GetShipmentFacts()
        {
            ...
            if (CurrentConfiguration.ShipmentAllocationInstance.AutoAllocateItems)
            {
                ...
                ChangeOrder(facts.AllocationDetails);
            }
            else
