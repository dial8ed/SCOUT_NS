/*
 * Windows API named constant values.
 */
...
{
    /// <summary>
    /// Holds a list of WinApi constant values.
    /// </summary>
    public static class Constant
    {
        ...
        // Messages for controls not defined.
        ...
        /*
             * For unicode apps WM_KEYLAST is aliased to WM_UNICHAR in WinUser.h
             */
        ...
        /*
             * WM_MOUSELAST appears to change depending on what version of 
             * Windows the code is compiled against in WinUser.h.
             * 
             * Its a pretty safe bet that the user is at least using Win2K 
             * for a .NET application.
             */
        public const int WM_MOUSELAST = 0x020D;
        //public const int WM_MOUSELAST = 0x020A; // NT 4.0
        //public const int WM_MOUSELAST = 0x0209; // Older versions of Windows
        ...
        // TODO: Add control messages here.

        #endregion

        #region Hit Test Results
        ...
        // C# can be SUCH a pain......
        //public const int WS_POPUP     = 0x80000000;
        public const int WS_POPUP = -2147483648; // Same as above;
        ...
        public const int WS_EX_OPERLAPPEDWINDOW =
            WS_EX_WINDOWEDGE |
            WS_EX_CLIENTEDGE;
        ...
        public const int INFINITE = -1; // Same as: 0xFFFFFFFF;

        #region OS Version INfo

        public const int MAJOR_WIN_95 = 4;
        public const int MAJOR_WIN_98 = 4;
        public const int MAJOR_WIN_ME = 4;
        public const int MAJOR_WIN_NT_351 = 3;
        public const int MAJOR_WIN_NT_400 = 4;
        public const int MAJOR_WIN_2000 = 5;
        public const int MAJOR_WIN_XP = 5;
        public const int MAJRO_WIN_SERVER_2003 = 5;

        public const int MINOR_WIN_95 = 0;
        public const int MINOR_WIN_98 = 10;
        public const int MINOR_WIN_ME = 90;
        public const int MINOR_WIN_NT_351 = 51;
        public const int MINOR_WIN_NT_400 = 0;
        public const int MINOR_WIN_NT_2000 = 0;
        public const int MINOR_WIN_XP = 1;
        public const int MINOR_WIN_SERVER_2003 = 2;

        #endregion

        #region Internet Function Constants
        ...
        public const int INTERNET_OPEN_TYPE_PRECONFIG_WITH_NO_AUTOPROXY =
            4;

        // FTP Transfer
        public const int INTERNET_FLAG_TRANSFER_ASCII = 0x00000001;
        public const int INTERNET_FLAG_TRANSFER_BINARY = 0x00000002;

        // Caching Flags
        public const int INTERNET_FLAG_NEED_FILE = 0x00000010;
        public const int INTERNET_FLAG_FWD_BACK = 0x00000020;
        public const int INTERNET_FLAG_FORMS_SUBMIT = 0x00000040;
        public const int INTERNET_FLAG_CACHE_ASYNC = 0x00000080;
        public const int INTERNET_FLAG_PRAGMA_NOCACHE = 0x00000100;
        public const int INTERNET_FLAG_NO_UI = 0x00000200;
        public const int INTERNET_FLAG_HYPERLINK = 0x00000400;
        public const int INTERNET_FLAG_RESYNCHRONIZE = 0x00000800;

        // Security Ignore Flags
        public const int INTERNET_FLAG_IGNORE_CERT_CN_INVALID
            = 0x00001000;
        public const int INTERNET_FLAG_IGNORE_CERT_DATE_INVALID
            = 0x00002000;
        public const int INTERNET_FLAG_IGNORE_REDIRECT_TO_HTTPS
            = 0x00004000;
        public const int INTERNET_FLAG_IGNORE_REDIRECT_TO_HTTP
            = 0x00008000;
        // Additional Flags
        public const int INTERNET_FLAG_CACHE_IF_NET_FAIL = 0x00010000;
        public const int INTERNET_FLAG_RESTRICTED_ZONE = 0x00020000;
        public const int INTERNET_FLAG_NO_AUTH = 0x00040000;
        public const int INTERNET_FLAG_NO_COOKIES = 0x00080000;
        public const int INTERNET_FLAG_READ_PREFETCH = 0x00100000;
        public const int INTERNET_FLAG_NO_AUTO_REDIRECT = 0x00200000;
        public const int INTERNET_FLAG_KEEP_CONNECTION = 0x00400000;
        ...
        public const int INTERNET_FLAG_MAKE_PERSISTENT = 0x02000000;
        public const int INTERNET_FLAG_DONT_CACHE = 0x04000000;
        public const int INTERNET_NO_CACHE_WRITE = 0x04000000;
        ...
        // Flags to common open functions (not InternetOpen())
        public const int INTERNET_FLAG_RELOAD = unchecked((int)0x80000000);

        // Common port numbers
        public const int INTERNET_INVALID_PORT_NUMBER = 0;
        ...
        public const int VER_PLATFORMID = 0x0000000F;
        ...
        public const int PROCESS_ALL_ACCESS = (
                                                  STANDARD_RIGHTS_REQUIRED | SYNCHRONIZE | 0x0FFF);

        #region System Defined Icons
