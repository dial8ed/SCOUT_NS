...
#if DEBUG
            SCOUT.Core.Data.Helpers.Config["DB:SCOUT"] = string.Format(baseStr, "DEV_SCOUT", "127.0.0.1");
            SCOUT.Core.Data.Helpers.Config["DB:Settings"] = string.Format(baseStr, "DEV_SCOUT_SETTINGS", "127.0.0.1");
            SCOUT.Core.Data.Helpers.Config["DB:Security"] = string.Format(baseStr, "DEV_SCOUT_SECURITY", "127.0.0.1");

            xpoStr = MSSqlConnectionProvider.GetConnectionString(
                "127.0.0.1", "sa", "C@td@ddy1", "DEV_SCOUT");
